...
import { p as parseURL, m as encodePath, o as decodePath, q as hasProtocol, r as isScriptProtocol, l as joinURL, w as withQuery, s as sanitizeStatusCode, t as getContext, $ as $fetch, v as createHooks, h as createError$1, x as executeAsync, y as defu } from '../_/nitro.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-B_rHvHGa.mjs')
  },
  {
    name: "jokes",
    path: "/jokes",
    component: () => import('./jokes-CtpJn2tC.mjs')
  },
  {
    name: "contact",
    path: "/contact",
    component: () => import('./contact-DbJTzXPf.mjs')
  },
  {
    name: "projects",
    path: "/projects",
    component: () => import('./projects-CLt0tHZ8.mjs')
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-1Fmfz2bA.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-CltqiteF.mjs'));
